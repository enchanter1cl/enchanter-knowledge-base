...
- Clients *within* the Docker network connect using listener “BOB”, with port 29092 and hostname `kafka0`. In doing so, they get back the hostname `kafka0` to which to connect. 
